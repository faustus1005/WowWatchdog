...
$ThemePalettes = [ordered]@{
    ...
    "Mists of Pandaria" = [ordered]@{
        "Theme.WindowBackgroundBrush"    = "#FF0A1412"
        "Theme.InputBackgroundBrush"     = "#FF10201D"
        "Theme.TitleBackgroundBrush"     = "#FF0E1B19"
        "Theme.PanelGradientTopColor"    = "#FF16302A"
        "Theme.PanelGradientBottomColor" = "#FF0C1F1B"
        "Theme.BorderStrongBrush"        = "#FF3D5B47"
        "Theme.BorderInputBrush"         = "#FF6A8E64"
        "Theme.ButtonPrimaryBrush"       = "#FF3E6F57"
        "Theme.ButtonPrimaryBorderBrush" = "#FF2E5946"
        "Theme.ButtonStartBrush"         = "#FF4A7F4C"
        "Theme.ButtonStartBorderBrush"   = "#FF2F5D36"
        "Theme.ButtonStopBrush"          = "#FF8A4A3C"
        "Theme.ButtonStopBorderBrush"    = "#FF68342A"
        "Theme.ButtonSecondaryBrush"     = "#FF1B322C"
        "Theme.TitleCloseBackgroundBrush"= "#FF5E3A2B"
        "Theme.TitleCloseBorderBrush"    = "#FF7D513D"
        "Theme.TextHeadingBrush"         = "#FFE8DFAF"
        "Theme.TextSubtleBrush"          = "#FFBDD3B0"
        "Theme.TextDisabledBrush"        = "#FF777777"
        "Theme.TextWarningBrush"         = "#FFF4C16B"
        "Theme.TextInfoBrush"            = "#FFE2F2E7"
        "Theme.TextHighlightBrush"       = "#FF9BD4A4"
    }
    Cataclysm = [ordered]@{
